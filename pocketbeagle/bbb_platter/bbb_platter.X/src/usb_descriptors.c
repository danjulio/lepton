...
const USB_DEVICE_DESCRIPTOR device_dsc=
{
    ...
    0x04D8,                 // Vendor ID
    0xF19C,                 // Product ID: danjuliodesigns, LLC "Pi Platter"
    (FW_MAJOR<<8)|FW_MINOR, // Device release number in BCD format
